...
export type ReduxAction =
 | RA_AssignAPIKey
 | RA_AddLocation | RA_RemoveLocation | RA_UpdateLocation
 | RA_UpdateSearchQuery | RA_UpdateSearchResults | RA_ClearSearchResults
...
export const addLocation = (location: LocationData, data?: PureWeatherData): RA_AddLocation => ({
    type: 'locations/add',
    uid: uuidv4(),
    location: location,
    data: data,
...
export const updateLocation = (uid: string, location: LocationData | null, data: PureWeatherData): RA_UpdateLocation => ({
    type: 'locations/update',
    uid: uid,
...
export const updateSearchResults = (results: LocationData[]): RA_UpdateSearchResults => ({
    type: 'search/update_results',
    results: results
})
